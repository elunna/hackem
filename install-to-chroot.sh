...
NHSUBDIR="hackem-1.0.0"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/hackem-1.0.0/var/"
# END OF CONFIG
##############################################################################
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-hackem100"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-hackem100"
