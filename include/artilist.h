...
STATIC_OVL NEARDATA struct artifact artilist[] = {
    ...
    A("Deep Freeze", ATHAME, (SPFX_RESTR | SPFX_ATTK | SPFX_DEFN), 0, 0,
      COLD(5,5), DFNS(AD_COLD), NO_CARY, 0, A_CHAOTIC, PM_ICE_MAGE, NON_PM, 400L, CLR_BLUE),
   ...
   */
    ...
    /*** Alignment artifact keys ***/
    
    A("The Key of Law", SKELETON_KEY,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL), 0, 0,
      NO_ATTK, NO_DFNS, NO_CARY, 0, A_LAWFUL, NON_PM, NON_PM, 1000L, NO_COLOR ),

    A("The Key of Neutrality", SKELETON_KEY,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL), 0, 0,
      NO_ATTK, NO_DFNS, NO_CARY, 0, A_NEUTRAL, NON_PM, NON_PM, 1000L, NO_COLOR ),

    A("The Key of Chaos", SKELETON_KEY,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL), 0, 0,
      NO_ATTK, NO_DFNS, NO_CARY, 0, A_CHAOTIC, NON_PM, NON_PM, 1000L, NO_COLOR ),
