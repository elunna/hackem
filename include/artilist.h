...
STATIC_OVL NEARDATA struct artifact artilist[] = {
    ...
    *       overpowered. Used to be PM_KNIGHT. */
    ...
    A("Mortality Dial", EXECUTIONER_S_MACE, (SPFX_RESTR | SPFX_REGEN),
      0, 0, PHYS(5, 5), NO_DFNS, NO_CARY, 0, A_LAWFUL, NON_PM, NON_PM,
    ...
    A("Snickersnee", KATANA, (SPFX_RESTR | SPFX_DEFN), 0, 0, 
      PHYS(5, 8), DFNS(AD_STUN), NO_CARY, 0, A_LAWFUL, NON_PM, 
    ...
    A("Circe's Witchstaff", STAFF_OF_MATTER,
      ...
      PHYS(8, 4), NO_DFNS, NO_CARY, 0, A_NEUTRAL, NON_PM, NON_PM, 5500L,
      CLR_GREEN, COPPER),
    
    A("Cleaver", BATTLE_AXE, SPFX_RESTR, 0, 0, PHYS(3, 6), NO_DFNS, NO_CARY,
      0, A_NEUTRAL, PM_BARBARIAN, NON_PM, 1500L, NO_COLOR, DEFAULT_MAT),
      
    A("David's Sling", SLING, (SPFX_RESTR | SPFX_ATTK | SPFX_HPHDAM 
        | SPFX_WARN | SPFX_DFLAGH), 0, MH_GIANT, PHYS(5, 0), NO_DFNS, NO_CARY,
      0, A_NEUTRAL, NON_PM, NON_PM, 2000L, NO_COLOR, DEFAULT_MAT),
   ...
   *      (handled as special case in spec_dbon()). */
    ...
    *      This effect is only active while the user can see. */
    ...
    A("Thunderstruck", MORNING_STAR, (SPFX_RESTR | SPFX_ATTK | SPFX_DEFN), 0, 0,
      LOUD(5, 0), DFNS(AD_LOUD), NO_CARY, 0, A_NONE, NON_PM, NON_PM, 3000L,
      NO_COLOR, DEFAULT_MAT),
 ...
 /* For now HackEM does not have any forged artifacts. This one from
    ...
    A("Itlachiayaque", SHIELD_OF_REFLECTION,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL | SPFX_ESP | SPFX_HSPDAM), SPFX_WARN, 0,
    ...
    A("The Candle of Eternal Flame", MAGIC_CANDLE,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL), (SPFX_WARN | SPFX_TCTRL), 
    ...
    */
    ...
    A("The Iron Spoon of Liberation", SPOON,
      ...
      (SPFX_LUCK), 0, PHYS(5,0), DFNS(AD_PLYS), NO_CARY, PHASING,
