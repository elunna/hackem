...
STATIC_OVL NEARDATA struct artifact artilist[] = {
    ...
    *       overpowered. Used to be PM_KNIGHT. */
    ...
    A("Firewall", STAFF_OF_DIVINATION, (SPFX_RESTR | SPFX_ATTK | SPFX_DEFN), 0, 0,
      ...
      PM_FLAME_MAGE, NON_PM, 400L, CLR_RED),
    ...
    A("Spear of Light", SPEAR, (SPFX_RESTR | SPFX_INTEL | SPFX_DFLAGH), 0, MH_UNDEAD,
      PHYS(5,10), NO_DFNS, NO_CARY, LIGHT_AREA, A_LAWFUL, PM_UNDEAD_SLAYER, NON_PM, 4000L, NO_COLOR),
    ...
    *       mounted person it hits. */
    ...
    A("Disrupter", MACE, (SPFX_RESTR | SPFX_DFLAGH), 0, MH_UNDEAD,
      PHYS(5,30), NO_DFNS, NO_CARY, 0, A_NEUTRAL, NON_PM, NON_PM, 500L, NO_COLOR),
    ...
    */
    ...
    A("Mouser\'s Scalpel", RAPIER, SPFX_RESTR, 0, 0,
      PHYS(5, 1), NO_DFNS, NO_CARY, 0, A_NEUTRAL, NON_PM, NON_PM, 600L, NO_COLOR ),
    ...
    A("Sword of Balance", SHORT_SWORD, (SPFX_RESTR | SPFX_DALIGN), 0, 0,
      PHYS(2, 5), DFNS(AD_CLOB), NO_CARY, 0, A_NEUTRAL, NON_PM, NON_PM, 5000L, NO_COLOR),
    ...
    A("Bat from Hell", BASEBALL_BAT,
      (SPFX_RESTR), 0, 0,
      PHYS(3, 20), NO_DFNS, NO_CARY, 0, A_CHAOTIC, NON_PM, NON_PM, 5000L, CLR_RED),
    ...
    A("Deathsword", TWO_HANDED_SWORD,
      ...
      PHYS(5, 14), NO_DFNS, NO_CARY, 0, A_CHAOTIC, NON_PM, NON_PM, 5000L, NO_COLOR),

    A("Deep Freeze", ATHAME, (SPFX_RESTR | SPFX_ATTK | SPFX_DEFN), 0, 0,
      COLD(5, 5), DFNS(AD_COLD), NO_CARY, SEFFECT, A_CHAOTIC, PM_ICE_MAGE, NON_PM, 400L, CLR_BLUE),
   ...
   *      (handled as special case in spec_dbon()). */
    ...
    */
    ...
    A("Plague", ORCISH_BOW, (SPFX_RESTR | SPFX_DEFN), 0, 0,
      PHYS(5,7), DFNS(AD_DRST), DFNS(AD_DISE), 0, A_CHAOTIC, NON_PM, NON_PM, 6000L, NO_COLOR),
   ...
   */
    ...
    *       happens to destroy tons of items. 
    ...
    A("The Great Dagger of Glaurgnaa", GREAT_DAGGER,
      ...
      PM_NECROMANCER, NON_PM, 5000L, NO_COLOR),
