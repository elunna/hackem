...
STATIC_OVL NEARDATA struct artifact artilist[] = {
    ...
    A("Sword of Justice", LONG_SWORD, (SPFX_RESTR | SPFX_DALIGN), 0, 0,
      PHYS(5, 12), NO_DFNS, NO_CARY, 0, A_LAWFUL, NON_PM, NON_PM, 1500L, NO_COLOR),
    ...
    A("Deep Freeze", STAFF_OF_ESCAPE, (SPFX_RESTR | SPFX_ATTK | SPFX_DEFN), 0, 0,
   ...
   */
    ...
    A("The Candle of Eternal Flame", MAGIC_CANDLE,
      ...
      NO_ATTK, NO_DFNS, CARY(AD_COLD), SUMMON_FIRE_ELEMENTAL, A_NEUTRAL, 
    ...
    A("The Storm Whistle", MAGIC_WHISTLE,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL), (SPFX_WARN | SPFX_TCTRL), 0,
      NO_ATTK, NO_DFNS, CARY(AD_FIRE), SUMMON_WATER_ELEMENTAL, 
