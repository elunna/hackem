...
E boolean FDECL(use_mask, (struct obj **));
...
E void FDECL(glow_warning_effects, (struct obj *));
E void NDECL(blind_glow_warnings);
E void FDECL(Sting_effects, (int));
E void FDECL(Sting_effects_offhand, (int));
...
E const char *FDECL(rank_of_mplayer, (int, struct monst *, BOOLEAN_P));
...
E boolean FDECL(is_grass, (int, int));
...
E void FDECL(doventbomb, (struct obj *, int, int));
...
E struct permonst *FDECL(ventmon, (int));
...
E int FDECL(living_to_undead, (int));
...
E void minfestcorpse(struct monst *);
...
E int FDECL(meatcatnip, (struct monst *));
...
E boolean FDECL(breakarm, (struct monst *));
E boolean FDECL(sliparm, (struct monst *));
...
E void FDECL(init_mplayer_erac, (struct monst *, int));
E struct monst *FDECL(mk_mplayer,
     (struct permonst *, XCHAR_P, XCHAR_P, BOOLEAN_P, struct obj *));
E void FDECL(outfit_mplayer, (struct monst *, BOOLEAN_P, struct obj *));
...
E int volleymu(struct monst *, struct attack *);
E int FDECL(breamu, (struct monst *, struct attack *));
E boolean FDECL(linedup_callback, (XCHAR_P, XCHAR_P, XCHAR_P, XCHAR_P,
                                   boolean FDECL((*), (int,int))));
...
E int volleymm(struct monst *, struct attack *, struct monst *);
...
E void FDECL(toggle_seeinv, (struct obj *, long, BOOLEAN_P));
...
E void FDECL(make_afraid, (long, BOOLEAN_P));
E void FDECL(make_fearless, (long, BOOLEAN_P));
...
E void FDECL(saveoracle, (int, int));
E void FDECL(savecharon, (int, int));
...
extern int steal(struct monst *, char *, BOOLEAN_P);
...
E boolean FDECL(decide_to_teleport, (struct monst *));
...
E void FDECL(attach_spirit_fade_timeout, (struct obj *, long));
...
E boolean NDECL(in_hell_effects);
...
E int FDECL(special_dmgval, (struct monst *, struct monst *, long,
                             struct obj **));
E struct damage_info_t dmgval_info(struct obj*);
...
E boolean FDECL(zombie_can_dig, (XCHAR_P, XCHAR_P));
