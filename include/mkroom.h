...
enum roomtype_types {
    ...
    TERRORHALL      = 28, /* hulks */
    ARTROOM         = 29, /* hulks */
    RNDVAULT        = 30, /* random vault, not to be confused with VAULT */
    BLACKFOYER      = 31, /* Foyer to the black market */
                      
    SHOPBASE        = 32, /* everything above this is a shop */
    ARMORSHOP       = 33, /* specific shop defines for level compiler */
    SCROLLSHOP      = 34,
    POTIONSHOP      = 35,
    WEAPONSHOP      = 36,
    FOODSHOP        = 37,
    ...
    MASKSHOP        = 43,
    JUNKSHOP        = 44,
    FODDERSHOP      = 45, /* health food */
    TINSHOP         = 46,
    GUNSHOP         = 47,
    INSTRUMENTSHOP  = 48,
    PETSHOP         = 49, /* Stephen White */
    CANDLESHOP      = 50, /*(UNIQUESHOP) */
    BLACKSHOP       = 51  /*(UNIQUESHOP) */
};
