...
enum roomtype_types {
    ...
    ZROOM      = 25, /* molds, puddings, and slime */
    MINIGUILD  = 26, /* Replacement for SlashEM guild of Disgruntled Adventurers. */
    CLINIC     = 27, /* nurses */
    TERRORHALL = 28, /* hulks */
    RNDVAULT   = 29, /* random vault, not to be confused with VAULT */
    BLACKFOYER = 30, /* Foyer to the black market */
                      
    SHOPBASE   = 31, /* everything above this is a shop */
    ARMORSHOP  = 32, /* specific shop defines for level compiler */
    SCROLLSHOP = 33,
    POTIONSHOP = 34,
    WEAPONSHOP = 35,
    FOODSHOP   = 36,
    ...
    MASKSHOP   = 42,
    JUNKSHOP   = 43,
    FODDERSHOP = 44, /* health food store */
    TINSHOP    = 45,
    GUNSHOP    = 46,
    INSTRUMENTSHOP = 47,
    PETSHOP    = 48, /* Stephen White */
    CANDLESHOP = 49, /*(UNIQUESHOP) */
    BLACKSHOP  = 50  /*(UNIQUESHOP) */
};
