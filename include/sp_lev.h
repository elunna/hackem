...
#define SPOOKY		            0x00000020L
#define MAZELEVEL               0x00000040L
#define PREMAPPED               0x00000080L /* premapped level & sokoban rules */
#define SHROUD                  0x00000100L
#define GRAVEYARD               0x00000200L
#define ICEDPOOLS               0x00000400L /* for ice locations: ICED_POOL vs ICED_MOAT */
#define SOLIDIFY                0x00000800L /* outer areas are nondiggable & nonpasswall */
#define CORRMAZE                0x00001000L /* for maze levels only */
#define FLAG_RNDVAULT           0x00002000L
#define CHECK_INACCESSIBLES     0x00004000L/* check for inaccessible areas and
