...
enum screen_symbols {
    ...
    S_grass     = 40,
    S_lava      = 41,
    S_vodbridge = 42, /* open drawbridge, vertical wall */
    S_hodbridge = 43, /* open drawbridge, horizontal wall */
    S_vcdbridge = 44, /* closed drawbridge, vertical wall */
    S_hcdbridge = 45, /* closed drawbridge, horizontal wall */
    S_air       = 46,
    S_cloud     = 47,
    S_puddle    = 48,
    S_sewage    = 49,
...
/* end dungeon characters, begin traps */
    ...
    S_bolt_trap            = 52,
    S_dart_trap            = 53,
    S_falling_rock_trap    = 54,
    S_squeaky_board        = 55,
    S_bear_trap            = 56,
    S_land_mine            = 57,
    S_rolling_boulder_trap = 58,
    S_sleeping_gas_trap    = 59,
    S_rust_trap            = 60,
    S_fire_trap            = 61,
    S_pit                  = 62,
    S_spiked_pit           = 63,
    S_hole                 = 64,
    S_trap_door            = 65,
    S_teleportation_trap   = 66,
    S_level_teleporter     = 67,
    S_magic_portal         = 68,
    S_web                  = 69,
    S_statue_trap          = 70,
    S_magic_trap           = 71,
    S_anti_magic_trap      = 72,
    S_ice_trap             = 73,
    S_polymorph_trap       = 74,
    S_spear_trap           = 75,
    S_magic_beam_trap      = 76,
    S_vibrating_square     = 77, /* for display rather than any trap effect */

    /* end traps, begin special effects */

    S_vbeam     = 78, /* The 4 zap beam symbols.  Do NOT separate. */
    S_hbeam     = 79, /* To change order or add, see function      */
    S_lslant    = 80, /* zapdir_to_glyph() in display.c.           */
    S_rslant    = 81,
    S_digbeam   = 82, /* dig beam symbol */
    S_flashbeam = 83, /* camera flash symbol */
    S_boomleft  = 84, /* thrown boomerang, open left, e.g ')'    */
    S_boomright = 85, /* thrown boomerang, open right, e.g. '('  */
    S_ss1       = 86, /* 4 magic shield ("resistance sparkle") glyphs */
    S_ss2       = 87,
    S_ss3       = 88,
    S_ss4       = 89,
    S_poisoncloud = 90,
    S_goodpos   = 91, /* valid position for targeting via getpos() */

    /* The 8 swallow symbols.  Do NOT separate.  To change order or add, */
    /* see the function swallow_to_glyph() in display.c.                 */
    S_sw_tl     = 92, /* swallow top left [1]             */
    S_sw_tc     = 93, /* swallow top center [2]    Order: */
    S_sw_tr     = 94, /* swallow top right [3]            */
    S_sw_ml     = 95, /* swallow middle left [4]   1 2 3  */
    S_sw_mr     = 96, /* swallow middle right [6]  4 5 6  */
    S_sw_bl     = 97, /* swallow bottom left [7]   7 8 9  */
    S_sw_bc     = 98, /* swallow bottom center [8]        */
    S_sw_br     = 99, /* swallow bottom right [9]         */

    S_explode1  = 100, /* explosion top left               */
    S_explode2  = 101, /* explosion top center             */
    S_explode3  = 102, /* explosion top right        Ex.   */
    S_explode4  = 103, /* explosion middle left            */
    S_explode5  = 104, /* explosion middle center    /-\   */
    S_explode6  = 105, /* explosion middle right     |@|   */
    S_explode7  = 106, /* explosion bottom left      \-/   */
    S_explode8  = 107, /* explosion bottom center          */
    S_explode9  = 108, /* explosion bottom right           */

    /* end effects */

    MAXPCHARS   = 109  /* maximum number of mapped characters */
...
#define poisonvnt  horizontal /* vent emits toxic gas */
...
struct levelflags {
    ...
    uchar nvents;     /* number of vents on level */
    ...
    uchar nmagicchests; /* number of magic chests on the level */
