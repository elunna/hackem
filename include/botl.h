...
enum statusfields {
    ...
    BL_XP, BL_AC, BL_MC, BL_HD, BL_TIME, BL_REALTIME, BL_HUNGER, BL_HP, /* 13..20 */
...
#define BL_MASK_PHASING         0x00010000L
#define BL_MASK_BITS            17 /* number of mask bits that can be set */
/* clang-format on */
