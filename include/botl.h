...
enum statusfields {
    ...
    BL_XP, BL_AC, BL_MC, BL_TOHIT, BL_HD, BL_TIME, BL_HUNGER, /* 13..19 */
    BL_HP, BL_HPMAX, BL_LEVELDESC, BL_EXP, BL_CONDITION, /* 20..24 */
    MAXBLSTATS /* [25] */
};
...
#define BL_MASK_SLOW            0x00002000L
#define BL_MASK_WITHER          0x00004000L
#define BL_MASK_AFRAID          0x00008000L
#define BL_MASK_BITS            16 /* number of mask bits that can be set */
/* clang-format on */
