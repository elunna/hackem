...
const struct class_sym def_monsyms[MAXMCLASSES] = {
    ...
    { DEF_LIGHT, "", "light" },
    { DEF_ZOUTHERN, "", "zouthern" },
    { DEF_ANGEL, "", "angelic being" },
    { DEF_BAT, "", "bat or bird" },
    { DEF_CENTAUR, "", "centaur" },
    { DEF_DRAGON, "", "dragon" },
    { DEF_ELEMENTAL, "", "elemental" },
    { DEF_FUNGUS, "", "fungus, mold or fern" },
    { DEF_GNOME, "", "gnome" },
    ...
    { DEF_EEL, "", "sea monster" },
    { DEF_LIZARD, "", "lizard" },
    { DEF_BAD_FOOD, "", "bad food" },
    { DEF_BAD_COINS, "", "bad coins" },
...
/*70*/ { '^', "anti-magic field", C(HI_ZAP) },         /* trap */
