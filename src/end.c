...
int how;
{
    ...
    if ((mon_nm == PM_GREEN_SLIME && !rn2(3))
        ...
        if (mon_nm != PM_GREEN_SLIME) {
            ...
            Your("soul does not leave your %s.",
...
int how;
{
    ...
    /* The player will rise as a spectre if killed by one
       ...
       or higher when they died */
        ...
        u.ugrave_arise = PM_BROWN_MOLDIER + rn2(7);
...
struct obj *list; /* inventory or container contents */
{
    ...
    for (obj = list; obj; obj = obj->nobj)
        ...
        } else if (obj->oclass == GEM_CLASS && obj->otyp <= LAST_GLASS) {
...
const genericptr vptr2;
{
    ...
    case VANQ_MCLS_LTOH:
        ...
        /* S_ANT through DEF_ZOUTHERN correspond to lowercase monster classes,
