...
static NEARDATA const int nasties[] = {
    ...
    /* chaotic */
    PM_BLACK_DRAGON, PM_RED_DRAGON, PM_DEMILICH, PM_VAMPIRE_KING,
    PM_MASTER_MIND_FLAYER, PM_DISENCHANTER, PM_WINGED_GARGOYLE,
    PM_STORM_GIANT, PM_OLOG_HAI, PM_MAGICAL_EYE, PM_ELVENKING,
    PM_OGRE_KING, PM_CAPTAIN, PM_GREMLIN, PM_HILL_GIANT_SHAMAN,
    /* lawful */
    PM_SILVER_DRAGON, PM_GOLD_DRAGON, PM_STONE_GIANT,
    PM_SHIMMERING_DRAGON, PM_GRAY_DRAGON, PM_DWARF_KING,
...
static NEARDATA const int vecna_nasties[] = {
    ...
    PM_VAMPIRE_LORD, PM_SHADE, PM_SPECTRE, PM_HEZROU,
...
static NEARDATA const unsigned wizapp[] = {
    PM_HUMAN,      PM_LAVA_DEMON,        PM_VAMPIRE_KING, PM_RED_DRAGON,
