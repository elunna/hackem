...
STATIC_VAR const struct paranoia_opts {
    ...
    { PARANOID_SWIM, "swim", 1, 0, 0,
      "y to walk into a water or lava space" },
        ...
        if ((op = string_for_env_opt(fullname, opts, negated))
            ...
            if (negated) {
                ...
                case 'q': /* quadruped */
                    ...
                    break;
                case 'i': /* homunculus */
                    /* 'h' is already taken, 'i' will suffice as
                       homunculi are represented as such */
                    preferred_pet = 'i';
                    break;
                case 'p': /* pseudodragon */
                    preferred_pet = 'p';
    ...
    if (match_optname(opts, fullname, 5, TRUE)) {
        ...
        if (negated) {
            ...
            return FALSE;
                                            ...
                                            != empty_optstr) {
            nmcpy(homunname, op, PL_PSIZ);
        } else
            return FALSE;
        sanitize_name(homunname);
        return retval;
    }
