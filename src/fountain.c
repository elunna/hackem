...
static const struct forge_recipe {
    ...
    { DARK_ELVEN_DAGGER, DARK_ELVEN_ARROW, KNIFE, 2, 1 },
    ...
    { DARK_ELVEN_SHORT_SWORD, CROSSBOW_BOLT, DARK_ELVEN_DAGGER, 2, 1 },
    ...
    { SABER, SCIMITAR, SHORT_SWORD, 1, 1 },
    { FALCHION, SCIMITAR, LONG_SWORD, 1, 1 },
