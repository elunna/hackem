...
NEARDATA struct permonst mons[] = {
    ...
    MON("redcap", S_IMP,                                      /* SpliceHack */
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_BERSERK, 0, 0, 
        7, CLR_RED),
    /*
     * jellies
     */
    ...
    MON("hobgoblin", S_ORC,
        ...
        M2_STRONG | M2_COLLECT | M2_FLANK, M3_INFRAVISIBLE | M3_INFRAVISION, 0,
        MH_ORC, 3, CLR_BROWN),
    ...
    MON("Mordor orc", S_ORC,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_BERSERK, 0, MH_ORC, 5, CLR_BLUE),
    MON("Uruk-hai", S_ORC,
    ...
    * depicts hands as well as wings */
    ...
    MON("Olog-hai", S_TROLL,
     ...
     MON("cave troll", S_TROLL,                               /* SpliceHack */
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 0, MH_TROLL,
        20, CLR_BROWN),
    ...
    MON("nosferatu", S_VAMPIRE,                     /* SpliceHack/SlashTHEM */
        ...
        M3_INFRAVISIBLE, 0, MH_UNDEAD | MH_VAMPIRE, 25, CLR_GRAY),
