...
NEARDATA struct permonst mons[] = {
    ...
    MON("whirling sphere", S_EYE,                             /* SpliceHack */
        ...
        R_FIRE | MR_COLD | MR_ELEC | MR_DISINT | MR_SLEEP | MR_POISON
            | MR_ACID | MR_STONE, 0,
        M1_FLY | M1_BREATHLESS | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
    ...
    MON("mind flayer", S_HUMANOID,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_TRAITOR, 0, MH_ILLITHID, 13, CLR_BRIGHT_MAGENTA),
...
struct permonst _mons2[] = {
    ...
    * depicts hands as well as wings */
    ...
    MON("vampiric", S_VAMPIRE,       /* placeholder */
        ...
        M1_HUMANOID, M2_NOPOLY | M2_STRONG | M2_FLANK,
        M3_INFRAVISIBLE, M4_VULNERABLE_FIRE, 
        MH_VAMPIRE, 12, CLR_RED),
