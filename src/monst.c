...
NEARDATA struct permonst mons[] = {
    ...
    MON("giant praying mantis", S_ANT,                        /* SpliceHack */
        ...
        M2_HOSTILE | M2_FLANK, 0, M4_VULNERABLE_ACID, 0,
        9, CLR_GREEN),
    ...
    MON("dust devil", S_IMP,                                  /* SpliceHack */
        ...
        M2_STALK | M2_HOSTILE | M2_NASTY, 0, 0, MH_DEMON, 
        10, CLR_YELLOW),
