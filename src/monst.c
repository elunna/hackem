...
NEARDATA struct permonst mons[] = {
    ...
    MON("alhoon", S_HUMANOID,                                   /* EvilHack */
        LVL(26, 9, -6, 90, -15), (G_HELL | G_GENO | G_VECNA | G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 10),
...
struct permonst _mons2[] = {
    ...
    * depicts hands as well as wings */
     ...
     */
    MON("lich", S_LICH,
        LVL(11, 6, 0, 30, -9), (G_GENO | G_VECNA | G_NOCORPSE | 1),
    ...
    MON("demilich", S_LICH,
        LVL(14, 9, -2, 60, -12), (G_GENO | G_VECNA | G_NOCORPSE | 1),
    ...
    MON("master lich", S_LICH,
        LVL(17, 9, -4, 90, -15), (G_HELL | G_GENO | G_VECNA | G_NOCORPSE | 1),
    ...
    MON("arch-lich", S_LICH,
        LVL(25, 9, -6, 90, -15), (G_HELL | G_GENO | G_VECNA | G_NOCORPSE | 1),
