...
NEARDATA struct permonst mons[] = {
    ...
    MON("floating eye", S_EYE,
        ...
        M1_FLY | M1_AMPHIBIOUS | M1_NOLIMBS | M1_NOHEAD 
            | M1_NOTAKE | M1_REGEN | M1_MINDLESS,
    ...
    MON("acid sphere", S_EYE,                                   /* EvilHack */
        ...
        M1_FLY | M1_BREATHLESS | M1_NOLIMBS | M1_NOHEAD 
            | M1_MINDLESS | M1_NOTAKE, M2_HOSTILE | M2_NEUTER, 
        M3_INFRAVISIBLE, 0, 0, 10, CLR_YELLOW),
    MON("bloodshot eye", S_EYE,                                 /* Slash'EM */
        ...
        M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE | M3_SKITTISH, 0, 
        0, 8, CLR_RED),
...
struct permonst _mons2[] = {
    ...
    * depicts hands as well as wings */
    ...
    MON("arch-vile", S_LICH,
        ...
        M2_HOSTILE | M2_MAGIC, M3_INFRAVISION | M3_TRAITOR | M3_SKITTISH,
        0, MH_UNDEAD, 23, CLR_YELLOW),
...
#define SEDUCTION_ATTACKS_NO        /* parser skip*/ \
    ...
    MON("cartomancer", S_HUMAN,                                /* SpliceHack */
         LVL(10, 12, 10, 3, 0), (1),    
         A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
           NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
         SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
 ...
 */
    ...
    MON("Pelias", S_HUMAN,
        ...
        M2_NOPOLY | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, 0, MH_HUMAN, 22, HI_LORD),
    MON("King of Games", S_HUMAN, 
        LVL(20, 12, 0, 60, 0), (G_NOGEN | G_UNIQ),
         A(ATTK(AT_MAGC, AD_SPEL, 2, 8), 
