...
NEARDATA struct permonst mons[] = {
    ...
    MON("rabid wolf", S_DOG, 
        ...
        SIZ(500, 250, MS_BARK, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, 
        M3_INFRAVISIBLE | M3_TRAITOR, 0, 0, 8, CLR_BROWN),
    ...
    MON("dwarf", S_HUMANOID, LVL(0, 6, 10, 10, 4), G_NOGEN, /* placeholder */
     ...
     MON("dwarf thief", S_HUMANOID, LVL(2, 6, 10, 10, 4), (G_GENO | G_NOGEN),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_TRAITOR, MH_DWARF, 0, 
        4, CLR_BLACK),
    ...
    MON("rabid rat", S_RODENT, LVL(2, 12, 6, 0, 0), (G_GENO | 1),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_POIS | M1_CARNIVORE, M2_HOSTILE,
        M3_INFRAVISIBLE, 0, 0, 5, CLR_BROWN),
