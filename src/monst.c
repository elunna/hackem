...
NEARDATA struct permonst mons[] = {
    ...
    MON("snow ant", S_ANT,
        ...
        M1_ANIMAL | M1_NOHANDS | M1_OVIPAROUS | M1_CARNIVORE, M2_HOSTILE, 
        0, M4_VULNERABLE_FIRE, 0, 3, CLR_CYAN),
    ...
    MON("migo drone", S_ANT, LVL(7, 12, 0, 10, -5), (G_GENO | G_LGROUP | 2),
        ...
        M3_INFRAVISION | M3_TRAITOR, 0, 0, 7, CLR_GREEN),
    ...
    MON("migo warrior", S_ANT,
        ...
        M3_INFRAVISION | M3_TRAITOR, 0, 0, 10, CLR_YELLOW),
    ...
    MON("dingo puppy", S_DOG, LVL(2, 18, 6, 0, 0), (G_NOHELL | G_GENO | 1),
        ...
        M3_INFRAVISIBLE, 0, 0, 2, CLR_YELLOW),
    ...
    MON("pit bull", S_DOG, LVL(11, 15, 4, 0, 0), 
        ...
        SIZ(800, 250, MS_BARK, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_STRONG | M2_DOMESTIC, 
        M3_INFRAVISIBLE, 0, 0, 11, HI_DOMESTIC),    
    ...
    MON("rabid wolf", S_DOG, 
        ...
        SIZ(500, 250, MS_BARK, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, 
        M3_INFRAVISIBLE | M3_TRAITOR, 0, 0, 6, CLR_BROWN),
    ...
    MON("blinking eye", S_EYE, LVL(8, 12, 4, 0, 0), (G_NOHELL | G_GENO | 1),
        ...
        M3_INFRAVISIBLE, 0, 0, 8, CLR_CYAN),
    ...
    MON("werepanther", S_FELINE, LVL(5, 15, 6, 20, -7), (G_NOGEN | G_NOCORPSE),
        ...
        M3_INFRAVISIBLE, 0, MH_WERE, 5, CLR_BLACK),
    ...
    MON("kamadan", S_FELINE, LVL(4, 12, 4, 0, -3), (G_NOHELL | G_GENO | 1),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE,
        M3_INFRAVISIBLE, 0, 0, 4, CLR_ORANGE),
    ...
    MON("weretiger", S_FELINE, LVL(7, 12, 6, 20, -7), (G_NOGEN | G_NOCORPSE),
        ...
        M1_NOHANDS | M1_POIS | M1_REGEN | M1_CARNIVORE,
        M2_NOPOLY | M2_HOSTILE,
        M3_INFRAVISIBLE, 0, MH_WERE, 7, CLR_YELLOW),
    ...
    MON("hobbit pickpocket", S_HUMANOID, LVL(2, 9, 8, 0, -1), (G_GENO | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_SITM, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(500, 200, MS_HUMANOID, MZ_SMALL), 0, 0, M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("dretch", S_IMP, LVL(2, 12, 2, 20, -7), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_TRAITOR, 0, 0, 2, CLR_YELLOW),
    ...
    MON("rutterkin", S_IMP, LVL(5, 12, 2, 20, -7), (G_GENO | 1),
        ...
        SIZ(20, 10, MS_CUSS, MZ_TINY), 0, 0,
        M1_REGEN, M2_WANDER | M2_STALK, 
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_TRAITOR, 0, 0, 5, CLR_ORANGE),
    ...
    MON("nupperibo", S_IMP, LVL(7, 12, 0, 20, -7), (G_GENO | 1),
        ...
        SIZ(20, 10, MS_CUSS, MZ_TINY), 0, 0,
        M1_REGEN, M2_WANDER | M2_STALK, 
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_TRAITOR, 0, 0, 7, CLR_GREEN),
    MON("blood imp", S_IMP, LVL(9, 12, 0, 60, -7), (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_DRST, 3, 4), ATTK(AT_BITE, AD_PHYS, 3, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(20, 10, MS_CUSS, MZ_TINY), 0, 0,
        M1_REGEN, M2_WANDER | M2_STALK, 
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_TRAITOR, 0, 0, 9, CLR_BLACK),
    /*
     * jellies
     */
    ...
    MON("clear jelly", S_JELLY, LVL(6, 3, 8, 10, 0), (G_NOHELL | G_GENO | 1),
        ...
        M2_HOSTILE | M2_NEUTER, 0, 0, 0, 6, CLR_CYAN),
    MON("yellow jelly", S_JELLY, LVL(8, 5, 8, 20, 0), (G_NOHELL | G_GENO | 1),
        ...
        M2_HOSTILE | M2_NEUTER, 0, 0, 0, 8, CLR_YELLOW),
    MON("orange jelly", S_JELLY, LVL(8, 5, 8, 20, 0), (G_NOHELL | G_GENO | 1),
        ...
        M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD 
            | M1_MINDLESS | M1_ACID | M1_OMNIVORE, 
        M2_HOSTILE | M2_NEUTER, 0, 0, 0, 8, CLR_ORANGE),
    MON("rancid jelly", S_JELLY, LVL(12, 5, 8, 20, 0), (G_NOHELL | G_GENO | 1),
        ...
        M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD 
            | M1_MINDLESS | M1_ACID | M1_OMNIVORE, 
        M2_HOSTILE | M2_NEUTER, 0, 0, 0, 12, CLR_BLACK),
    /*
     * kobolds
     */
    ...
    MON("pixie", S_NYMPH,
        ...
        M3_INFRAVISIBLE, 0, 0, 3, CLR_CYAN),
    MON("brownie", S_NYMPH,
    ...
    MON("quickling", S_NYMPH,
        ...
        M3_INFRAVISIBLE | M3_TRAITOR, 0, 0, 3, CLR_BLUE),
    ...
    MON("bull", S_QUADRUPED,
        ...
        M1_ANIMAL | M1_NOHANDS | M1_HERBIVORE, M2_WANDER | M2_DOMESTIC 
            | M2_HOSTILE | M2_MALE, 
        M3_INFRAVISIBLE, 0, 0, 10, CLR_BLACK),
    ...
    MON("mastodon", S_QUADRUPED, LVL(20, 12, 5, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BUTT, AD_PHYS, 4, 8), ATTK(AT_HUGS, AD_PHYS, 1, 6),
          ATTK(AT_BUTT, AD_CLOB, 4, 8), NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("woolly mammoth", S_QUADRUPED, LVL(24, 10, 2, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BUTT, AD_PHYS, 6, 6), ATTK(AT_HUGS, AD_PHYS, 1, 8),
          ATTK(AT_BUTT, AD_CLOB, 6, 6), NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("scramper", S_QUADRUPED, 
        ...
        M3_INFRAVISIBLE, 0, 0, 3, CLR_GREEN),
    MON("squealer", S_QUADRUPED, 
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE | M1_POIS, M2_HOSTILE, 
        M3_INFRAVISIBLE, 0, 0, 4, CLR_MAGENTA),
    MON("mangler", S_QUADRUPED, 
        ...
        SIZ(400, 100, MS_SILENT, MZ_LARGE), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, 
        M3_INFRAVISIBLE | M3_TRAITOR, 0, 0, 8, CLR_ORANGE),
    /*
     * rodents
     */
    ...
    MON("black rat",  S_RODENT, 
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, 
        M3_INFRAVISIBLE, 0, 0, 0, CLR_BLACK),
    ...
    MON("rabbit", S_RODENT, 
        ...
        M3_INFRAVISIBLE, 0, 0, 0, CLR_WHITE),
    ...
    MON("the Rat King", S_RODENT, 
        ...
        M2_STRONG | M2_PNAME | M2_PRINCE | M2_MALE | M2_GREEDY | M2_STALK
            ...
            | M2_MAGIC, 
        M3_INFRAVISIBLE | M3_NOTAME, 0, 0, 12, HI_LORD),
    ...
    MON("werespider", S_SPIDER, LVL(11, 15, 3, 0, 0), (G_GENO | G_NOGEN | 1),
        ...
        M2_NOPOLY | M2_HOSTILE, 
        M3_INFRAVISIBLE, 0, MH_WERE, 11, CLR_BLACK),
    ...
    MON("Girtab", S_SPIDER, LVL(22, 15, 3, 0, 0), (G_UNIQ | G_NOGEN | 1),
        ...
        M2_STRONG | M2_PNAME | M2_PRINCE | M2_FEMALE | M2_STALK
            | M2_HOSTILE | M2_NASTY | M2_NOPOLY, 
        M3_INFRAVISION | M3_NOTAME, 0, 0, 22, CLR_RED),
    MON("Shelob", S_SPIDER, LVL(26, 15, 3, 0, 0), (G_UNIQ | G_NOGEN | 1),
        ...
        M2_STRONG | M2_PNAME | M2_PRINCE | M2_FEMALE | M2_STALK
            | M2_HOSTILE | M2_NASTY | M2_NOPOLY, 
        M3_INFRAVISION | M3_NOTAME, 0, 0, 26, CLR_BLACK),
    /*
     * trappers, lurkers, &c
     */
    ...
    */
    ...
    MON("movanic deva", S_ANGEL, LVL(12, 18, -5, 90, 15), 
      (G_NOHELL | G_NOCORPSE | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 0, MH_ANGEL, 12, CLR_BLUE),
    ...
    MON("Planetar", S_ANGEL, LVL(29, 16, -10, 80, 15), 
        (G_NOHELL | G_NOCORPSE | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 0, MH_ANGEL, 29, CLR_CYAN),
    MON("Solar", S_ANGEL, 
        ...
        M2_NOPOLY | M2_MINION | M2_STALK | M2_STRONG | M2_NASTY 
            | M2_LORD | M2_COLLECT | M2_MAGIC, 
        M3_INFRAVISIBLE | M3_INFRAVISION, 0, MH_ANGEL, 39, CLR_BROWN),
    /*
     * Bats
     */
    ...
    MON("mobat", S_BAT, 
        ...
        M1_FLY | M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE,
        M2_WANDER | M2_HOSTILE, 
        M3_INFRAVISIBLE, 0, 0, 9, CLR_BLACK),
    MON("harpy", S_BAT, 
        ...
        M1_FLY | M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE,
        M2_WANDER | M2_HOSTILE, 
        M3_INFRAVISIBLE | M3_TRAITOR, 0, 0, 9, CLR_GRAY),
    ...
    MON("byakhee", S_BAT, LVL(11, 20, 1, 25, -4), 
        (G_GENO | 2 | G_SGROUP),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_TRAITOR, 0, 0, 11, CLR_BROWN),
    MON("nightgaunt", S_BAT, LVL(15, 20, -2, 50, -6), 
        (G_GENO | 2 | G_SGROUP),
    ...
    MON("yellow dragon", S_DRAGON, LVL(15, 9, -1, 20, -7), (G_GENO | 1),
        A(ATTK(AT_BREA, AD_ACID, 4, 6), ATTK(AT_BITE, AD_PHYS, 4, 8),
          ATTK(AT_CLAW, AD_PHYS, 4, 4), ATTK(AT_CLAW, AD_PHYS, 4, 4),
          ATTK(AT_ENGL, AD_DGST, 2, 10), ATTK(AT_NONE, AD_CORR, 0, 2)),
    ...
    MON("hydra", S_DRAGON, LVL(26, 9, -4, 20, 7), (G_GENO|1),
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_SEE_INVIS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        0, 0, MH_DRAGON, 26, CLR_BRIGHT_GREEN),
    /*
     * Elementals
     */
    ...
    MON("gnome thief", S_GNOME, 
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_TRAITOR, 0, MH_GNOME, 1, CLR_BLACK),
    ...
    MON("deep gnome", S_GNOME, 
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 0, MH_GNOME, 5, CLR_GRAY),
    MON("gnome warrior", S_GNOME, 
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 0, MH_GNOME, 5, CLR_RED),
    MON("Ruggo the Gnome King", S_GNOME, 
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_TRAITOR, 0, MH_GNOME, 16, HI_LORD),
...
struct permonst _mons2[] = {
    ...
    MON("the Largest Giant", S_GIANT, LVL(26, 12, 0, 15, -3),
        (G_UNIQ | 1),
   ...
   MON("snark", S_JABBERWOCK, LVL(12, 18, 0, 30, 0), (2),
    ...
    MON("ogre mage", S_OGRE, LVL(7, 12, 3, 30, -5), 
        (G_NOHELL | G_GENO),
  ...
  MON("shadow ogre", S_OGRE, LVL(10, 14, 0, 60, -7), (G_HELL | G_GENO),
    ...
    MON("shoggoth", S_PUDDING,
        ...
        M2_HOSTILE | M2_NEUTER | M2_STALK | M2_NASTY | M2_STRONG 
            | M2_COLLECT | M2_MAGIC, 
        M3_INFRAVISION | M3_TRAITOR, 0, 0, 18, CLR_BLACK),
    MON("giant shoggoth", S_PUDDING,
        ...
        M2_HOSTILE | M2_NEUTER | M2_STALK | M2_NASTY | M2_STRONG 
            | M2_COLLECT | M2_MAGIC, 
        M3_INFRAVISION | M3_TRAITOR, 0, 0, 36, CLR_BLACK),
    /*
     * Quantum mechanics
     */
    ...
    MON("king cobra", S_SNAKE, LVL(9, 15, 2, 0, 0), (G_NOHELL | G_GENO),
        ...
        M2_HOSTILE, M3_ACCURATE, 0, 0,  9, CLR_GRAY),
    ...
    MON("weresnake", S_SNAKE, 
        ...
        M3_INFRAVISIBLE, 0, MH_WERE, 9, CLR_BROWN),
    MON("giant anaconda", S_SNAKE, LVL(10, 6, 2, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), ATTK(AT_HUGS, AD_WRAP, 2, 6),
    ...
    MON("wight", S_WRAITH, LVL(5, 12, 5, 5, -3), 
        (G_NOCORPSE | G_GENO | 1),
        ...
        M1_BREATHLESS | M1_HUMANOID,
        M2_STALK | M2_HOSTILE | M2_COLLECT, 
        0, M4_VULNERABLE_FIRE, MH_UNDEAD, 5, CLR_GRAY),
    ...
    MON("ghast", S_ZOMBIE, LVL(4, 6, 10, 0, -2), 
        (G_GENO | G_NOCORPSE | 1),
        ...
        M2_STALK | M2_HOSTILE, M3_INFRAVISION, 
        M4_VULNERABLE_FIRE, MH_UNDEAD, 4, CLR_MAGENTA),
    ...
    MON("ghoul mage", S_ZOMBIE, LVL(10, 12, 4, 10, -4), 
        ...
        M3_INFRAVISION | M3_TRAITOR, M4_VULNERABLE_FIRE, MH_UNDEAD, 10, CLR_BLACK),
    ...
    MON("ghoul queen", S_ZOMBIE, LVL(14, 12, 0, 30, -8), 
        (G_GENO | G_NOCORPSE | G_NOGEN | 1),
        A(ATTK(AT_CLAW, AD_PLYS, 1, 3), ATTK(AT_CLAW, AD_PHYS, 1, 4),
        ...
        M4_VULNERABLE_FIRE, MH_UNDEAD, 14, CLR_BLACK),
    MON("gug", S_ZOMBIE, LVL(15, 18, 5, 15, -4), 
        (G_GENO | G_NOCORPSE | 1 | G_LGROUP),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 6), ATTK(AT_CLAW, AD_PHYS, 2, 6),
        ...
        M3_INFRAVISION | M3_TRAITOR,  
        M4_VULNERABLE_FIRE, MH_UNDEAD, 15, CLR_BLACK),
    /*
     * golems
     */
    ...
    MON("wax golem", S_GOLEM, LVL(3, 12, 9, 0, 0), (G_NOCORPSE | 1),
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID,
        M2_HOSTILE | M2_NEUTER, 
        M3_INFRAVISIBLE, 0, 0, 3, CLR_GRAY),
    ...
    MON("steel golem", S_GOLEM, LVL(30, 15, 3, 60, 0), (G_NOCORPSE | 1),
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE | M1_POIS,
        M2_HOSTILE | M2_STRONG | M2_COLLECT | M2_NEUTER, 
        0, M4_VULNERABLE_ACID, 0, 30, CLR_BRIGHT_BLUE),
    ...
    MON("werepanther", S_HUMAN, LVL(5, 15, 10, 20, -7), (1),
        ...
        M1_HUMANOID | M1_POIS | M1_REGEN | M1_OMNIVORE,
        M2_NOPOLY | M2_HOSTILE | M2_COLLECT,
        M3_INFRAVISIBLE, 0, MH_HUMAN | MH_WERE, 5, CLR_BLACK),
    MON("weretiger", S_HUMAN, LVL(7, 12, 10, 20, -7), (1),
        ...
        M1_HUMANOID | M1_POIS | M1_REGEN | M1_OMNIVORE,
        M2_NOPOLY | M2_HOSTILE | M2_COLLECT,
        M3_INFRAVISIBLE, 0, MH_HUMAN | MH_WERE, 7, CLR_YELLOW),
    MON("weresnake", S_HUMAN, LVL(9, 12, 10, 20, -7), (0),
        ...
        M1_HUMANOID | M1_POIS | M1_REGEN | M1_OMNIVORE,
        M2_NOPOLY | M2_HOSTILE | M2_COLLECT,
        M3_INFRAVISIBLE, 0, MH_HUMAN | MH_WERE, 9, CLR_BROWN),
    ...
    MON("mugger", S_HUMAN, LVL(2, 12, 10, 0, -8), (G_GENO | G_NOGEN),
        ...
        M3_INFRAVISIBLE | M3_TRAITOR, 0, MH_HUMAN, 2, CLR_BLACK),
    ...
    MON("black marketeer", S_HUMAN, LVL(25, 24, -8, 50, -2), G_NOGEN,
        ...
        M2_NOPOLY | M2_PEACEFUL | M2_STRONG | M2_COLLECT 
            | M2_MAGIC | M2_MALE, 
        M3_ACCURATE | M3_INFRAVISIBLE, 0, MH_HUMAN, 25, CLR_BLACK),
    ...
    MON("gypsy", S_HUMAN, LVL(20, 12, -2, 90, 0), (G_GENO | 2),
        ...
        M3_TRAITOR | M3_INFRAVISIBLE, 0, MH_HUMAN, 20, HI_DOMESTIC),
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("bearded devil", S_DEMON, LVL(8, 15, 1, 45, 7), (G_HELL | G_NOCORPSE | 1),
        ...
        M3_TRAITOR, 0, MH_DEMON, 8, CLR_BLACK),
    ...
    MON("bar-lgura", S_DEMON, LVL(7, 15, -3, 45, -9), 
        ...
        M2_STALK | M2_HOSTILE | M2_NASTY,
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_TRAITOR, 
        0, MH_DEMON, 7, CLR_ORANGE),
    MON("chasme", S_DEMON, LVL(8, 21, -1, 40, -9), 
        (G_HELL | G_NOCORPSE | G_SGROUP | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 6), ATTK(AT_CLAW, AD_PHYS, 2, 6),
    ...
    MON("vrock", S_DEMON, LVL(8, 12, 0, 50, -9),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 0, MH_DEMON, 11, CLR_RED),
    MON("babau", S_DEMON, LVL(9, 15, -3, 50, -9), 
        (G_HELL | G_NOCORPSE | G_SGROUP | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
    ...
    MON("nabassu", S_DEMON, LVL(9, 15, -5, 50, -11), 
        (G_HELL | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4),
    ...
    MON("rhaumbusun", S_LIZARD, LVL(2, 9, 5, 0, 0), (G_HELL | G_GENO | 1),
        ...
        M2_NASTY | M2_HOSTILE, 0, 0, 0, 2, CLR_MAGENTA),
    MON("komodo dragon", S_LIZARD, LVL(9, 9, 5, 0, 0), (G_NOHELL | G_GENO | 1),
        ...
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_LARGE), 0, 0,
        M1_ANIMAL | M1_THICK_HIDE | M1_NOHANDS | M1_OVIPAROUS | M1_CARNIVORE, 
        M2_STRONG | M2_HOSTILE, 0, 0, 0, 9, CLR_GREEN),
...
/*      evil coins        */
    ...
    MON("flame mage", S_HUMAN, LVL(10, 12, 10, 3, 0), G_NOGEN,
        ...
        M3_INFRAVISIBLE, 0, MH_HUMAN, 10, CLR_RED),
    ...
    MON("yeoman", S_HUMAN, LVL(10, 10, 10, 1, 3), G_NOGEN,
        ...
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_COLLECT, 
        M3_INFRAVISIBLE,0, MH_HUMAN, 10, HI_DOMESTIC),
    ...
    MON("High Flame Mage", S_HUMAN, LVL(20, 12, 0, 40, 0), (G_NOGEN | G_UNIQ),
        ...
        M2_NOPOLY | M2_PNAME | M2_PEACEFUL | M2_STRONG 
            | M2_MALE | M2_COLLECT | M2_MAGIC, 
        M3_CLOSE | M3_INFRAVISIBLE, 0, MH_HUMAN, 20, HI_LORD),
    ...
    MON("Dark Lord", S_HUMAN, LVL(20, 12, 0, 60, -20), (G_NOGEN | G_UNIQ),
        ...
        M3_CLOSE, 0, MH_HUMAN, 20, HI_LORD),
    ...
    MON("igniter", S_HUMAN, LVL(5, 10, 10, 10, 3), G_NOGEN,
        ...
        MR_POISON, M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, 0, MH_HUMAN, 5, CLR_RED),
    MON("froster", S_HUMAN, LVL(5, 10, 10, 10, 3), G_NOGEN,
        ...
        MR_POISON, M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, 0, MH_HUMAN, 5, CLR_WHITE),
