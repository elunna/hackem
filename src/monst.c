...
NEARDATA struct permonst mons[] = {
    ...
    MON("juggernaut", S_QUADRUPED, 
        ...
        M1_ANIMAL | M1_THICK_HIDE | M1_NOHANDS | M1_HERBIVORE | M1_REGEN,
...
#define M1_MARSUPIAL 0
    ...
    */
    ...
    MON("rhumbat", S_BAT, LVL(3, 22, 7, 0, 0), (G_HELL | G_GENO | G_SGROUP | 1),
        ...
        M3_INFRAVISIBLE, 0, 0, 5, CLR_YELLOW),
    MON("athol", S_BAT, LVL(2, 20, 7, 0, 0), (G_HELL | G_GENO | G_LGROUP | 1),
...
#define SEDUCTION_ATTACKS_NO        \
    ...
    MON("bearded devil", S_DEMON, LVL(8, 15, 1, 45, 7), (G_HELL | G_NOCORPSE | 1),
        ...
        M3_TRAITOR, 0, MH_DEMON, 12, CLR_BLACK),
    ...
    MON("nabassu", S_DEMON, LVL(9, 15, -5, 50, -11), (G_HELL | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 4), 
          ...
          NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_LARGE), MR_FIRE | MR_POISON, 0, 
        M1_HUMANOID | M1_POIS | M1_FLY, M2_STALK | M2_HOSTILE | M2_NASTY, 
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_TRAITOR, 
    ...
    MON("komodo dragon", S_LIZARD, LVL(9, 9, 5, 0, 0), (G_NOHELL | G_GENO | 1),
        ...
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_LARGE), 0, 0,
        M1_ANIMAL | M1_THICK_HIDE | M1_NOHANDS | M1_OVIPAROUS | M1_CARNIVORE, 
        M2_STRONG | M2_HOSTILE, 0, 0, 0, 11, CLR_GREEN),
