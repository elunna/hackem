...
%token	<i> CORRIDOR_ID GOLD_ID ENGRAVING_ID FORGE_ID MAGIC_CHEST_ID FOUNTAIN_ID VENT_ID PUDDLE_ID SEWAGE_ID POOL_ID SINK_ID TOILET_ID NONE
...
magic_chest_detail : MAGIC_CHEST_ID ':' ter_selection
		  {
