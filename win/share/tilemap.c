...
#define EXTRA_SCROLL_DESCR_COUNT ((SCR_BLANK_PAPER - SCR_AIR) - 1)
 ...
 */
#ifndef MAIL
    { OBJ_GLYPH, SCR_AIR + EXTRA_SCROLL_DESCR_COUNT,
      "stamped / mail" },
#endif
    { 0, 0, 0 }
};
...
{S_vbeam,                "vertical beam", "cmap 76"},
{S_hbeam,                "horizontal beam", "cmap 77"},
{S_lslant,               "left slant beam", "cmap 78"},
{S_rslant,               "right slant beam", "cmap 79"},
{S_digbeam,              "dig beam", "cmap 80"},
{S_flashbeam,            "flash beam", "cmap 81"},
{S_boomleft,             "boom left", "cmap 82"},
{S_boomright,            "boom right", "cmap 83"},
{S_ss1,                  "shield1", "cmap 84"},
{S_ss2,                  "shield2", "cmap 85"},
{S_ss3,                  "shield3", "cmap 86"},
{S_ss4,                  "shield4", "cmap 87"},
{S_poisoncloud,          "poison cloud", "poison cloud"},
{S_goodpos,              "valid position", "valid position"},
{S_sw_tl,                "swallow top left", "cmap 90"},
{S_sw_tc,                "swallow top center", "cmap 91"},
{S_sw_tr,                "swallow top right", "cmap 92"},
{S_sw_ml,                "swallow middle left", "cmap 93"},
{S_sw_mr,                "swallow middle right", "cmap 94"},
{S_sw_bl,                "swallow bottom left ", "cmap 95"},
{S_sw_bc,                "swallow bottom center", "cmap 96"},
{S_sw_br,                "swallow bottom right", "cmap 97"},
