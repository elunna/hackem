...
%.lp ""
On Unix, Linux and Mac OS X it is \mbox{``.evilhackrc''} in the user's home
directory. The file may not exist, but it is a normal ASCII text file and
can be created with any text editor.\\

%.lp ""
On Windows, it is \mbox{``.evilhackrc''} in the folder
...
template for ths configuration file named \mbox{``.evilhackrc.template''} in
...
defaults to the location of the {\it EvilHack.exe\/} or {\it NetHackw.exe\/} file
